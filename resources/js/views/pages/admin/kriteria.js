...
$(document).ready(function () {
    ...
    const new_table = table_html.DataTable({
        ...
        {
            data: 'keterangan',
            name: 'keterangan', render(data, type, full, meta) {
        ...
        ...(can_update || can_delete ? [{
            ...
            render(data, type, full, meta) {
                const btn_nilai = `<a class="btn btn-rounded btn-secondary btn-sm me-1 mt-1" href="{{url(l_prefix_uri($hpu, 'nilai'))}}/${full.slug}" data-toggle="tooltip" title="SubKriteria">
