...
use App\Models\Import\Kriteria;
...
class KriteriaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $view = path_view('pages.admin.import.kriteria');
    ...
    public function insert(Request $request): mixed
    {
        try {
            ...
            $import = Kriteria::import($request, $model);
            if ($import['status']) {
                DB::commit();
    ...
    public function delete(Kriteria $model): mixed
    {
        try {
            ...
            $model->delete();
            $model->items()->delete();
            delete_file(Kriteria::excelFolder . "/" . $model->file);
            DB::commit();
            return response()->json();
        } catch (ValidationException $error) {
            return response()->json([
    ...
    {
        return Kriteria::format($request);
    }
}
